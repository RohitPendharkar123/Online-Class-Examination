...
<div class="row">
<div class="col-lg-6">
<span class="logo">RSML Online Exam System</span></div>
<?php
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Class</b></td><td><b>Year</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
  ...
  $time = $row['time'];
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$class.'</td><td>'.$year.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Class</b></td><td><b>Year</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
...
while($row = mysqli_fetch_array($result)) {
  ...
  $email = $row['email'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$class.'</td><td>'.$year.'</td><td>'.$email.'</td><td>'.$mob.'</td>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <select id="class" name="class" class="form-control input-md" placeholder="Select Class">
              <option value="Select">Select Class</option>
              <option value="BCs">B.Sc. C.S.</option>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <select id="year" name="year" class="form-control input-md" placeholder="Select Year">
