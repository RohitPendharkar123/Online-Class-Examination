...
if(@$_GET['fdid'] && $_SESSION['key']=='ykmane5600') {
$id=@$_GET['fdid'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='ykmane5600') {
$eid=@$_GET['eid'];
...
$desc = $_POST['desc'];
// $id=uniqid();
$q3=mysqli_query($con, "INSERT INTO quizes (`class`, `year`, `ename`, `total_q`, `per_q`, `ne_mark`, `time`, `tag`, `description`) VALUES ('$class', '$year', '$name', '$total', '$sahi', '$wrong', '$time', '$tag', '$desc')");
;
if($q3) {
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='ykmane5600') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='ykmane5600')
{
